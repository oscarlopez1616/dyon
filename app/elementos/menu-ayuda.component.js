System.register(['angular2/core', '../domains/desplegable-superior-derecha'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            MenuAyudaComponent = (function (_super) {
                __extends(MenuAyudaComponent, _super);
                function MenuAyudaComponent(injector) {
                    _super.call(this, injector);
                }
                MenuAyudaComponent = __decorate([
                    core_1.Component({
                        selector: "menu-ayuda",
                ...
                return MenuAyudaComponent;
            }(desplegable_superior_derecha_1.DesplegableSuperiorDerecha));
            exports_1("MenuAyudaComponent", MenuAyudaComponent);
        }
    }
});
//# sourceMappingURL=menu-ayuda.component.js.map