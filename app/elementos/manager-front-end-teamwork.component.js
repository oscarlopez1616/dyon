System.register(['angular2/core', '../domains/desplegable-superior-derecha'], function(exports_1, context_1) {
    ...
    var ManagerFrontEndTeamworkComponent;
    return {
        setters:[
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function() {
            ManagerFrontEndTeamworkComponent = (function (_super) {
                __extends(ManagerFrontEndTeamworkComponent, _super);
                function ManagerFrontEndTeamworkComponent(injector, _changeDetectionRef) {
                    _super.call(this, injector);
                    this._changeDetectionRef = _changeDetectionRef;
                    this.nombreEmisor = "oscar";
                    this.mensajes = [];
                }
                ManagerFrontEndTeamworkComponent.prototype.addMensaje = function (cuerpoMensaje) {
                    this.mensajes.push({ 'emisor': this.nombreEmisor, 'cuerpo': cuerpoMensaje });
                    this._changeDetectionRef.detectChanges();
                };
                ManagerFrontEndTeamworkComponent = __decorate([
                    core_1.Component({
                ...
                ], ManagerFrontEndTeamworkComponent);
                return ManagerFrontEndTeamworkComponent;
            }(desplegable_superior_derecha_1.DesplegableSuperiorDerecha));
            exports_1("ManagerFrontEndTeamworkComponent", ManagerFrontEndTeamworkComponent);
        }
    }
});
//# sourceMappingURL=manager-front-end-teamwork.component.js.map