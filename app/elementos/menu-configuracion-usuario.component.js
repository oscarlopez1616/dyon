System.register(['angular2/core', '../domains/desplegable-superior-derecha'], function(exports_1, context_1) {
    ...
    var MenuConfiguracionUsuarioComponent;
    return {
        setters:[
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function() {
            MenuConfiguracionUsuarioComponent = (function (_super) {
                __extends(MenuConfiguracionUsuarioComponent, _super);
                function MenuConfiguracionUsuarioComponent(injector) {
                    _super.call(this, injector);
                }
                MenuConfiguracionUsuarioComponent = __decorate([
                    core_1.Component({
                ...
                ], MenuConfiguracionUsuarioComponent);
                return MenuConfiguracionUsuarioComponent;
            }(desplegable_superior_derecha_1.DesplegableSuperiorDerecha));
            exports_1("MenuConfiguracionUsuarioComponent", MenuConfiguracionUsuarioComponent);
        }
    }
});
//# sourceMappingURL=menu-configuracion-usuario.component.js.map