System.register(['angular2/core', '../posiciones/pagina.component'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            MenuBreadCrumbsComponent = (function () {
                function MenuBreadCrumbsComponent(injector) {
                    this.pagina = injector.get(pagina_component_1.PaginaComponent).pagina;
                }
                MenuBreadCrumbsComponent = __decorate([
                    core_1.Component({
                ...
                ], MenuBreadCrumbsComponent);
                return MenuBreadCrumbsComponent;
            }());
            exports_1("MenuBreadCrumbsComponent", MenuBreadCrumbsComponent);
        }
    }
});
//# sourceMappingURL=menu-bread-crumbs.component.js.map